...
$("#filter").click(function () {
        ...
        success: function (data) {
            ...
            $.each(filterdata, function (i, item) {
                ...
                if (filterdata[i].time == "09:00:00.000" && $("#header" + [value]).text() == futDate) {
                    $('#slotdata tr:nth(1)').find('td').eq(value).find("button").addClass("btn btn-success")
                    
                }
                else if (filterdata[i].time == "09:30:00.000" && $("#header" + [value]).text() == futDate) {
                    $('#slotdata tr:nth(2)').find('td').eq(value).find("button").addClass("btn btn-success")
                   
                }
                else if (filterdata[i].time == "10:00:00.000" && $("#header" + [value]).text() == futDate) {
                    $('#slotdata tr:nth(3)').find('td').eq(value).find("button").addClass("btn btn-success")
                   
                }
                else if (filterdata[i].time == "10:30:00.000" && $("#header" + [value]).text() == futDate) {
                    $('#slotdata tr:nth(4)').find('td').eq(value).find("button").addClass("btn btn-success")
                    
                }
                else if (filterdata[i].time == "11:00:00.000" && $("#header" + [value]).text() == futDate) {
                    $('#slotdata tr:nth(5)').find('td').eq(value).find("button").addClass("btn btn-success")
                   
                }
                else if (filterdata[i].time == "11:30:00.000" && $("#header" + [value]).text() == futDate) {
                    $('#slotdata tr:nth(6)').find('td').eq(value).find("button").addClass("btn btn-success")
    ...
    $.each(data, function (i, item) {
        ...
        $("#slotdata").append("<tr><td> <h2> <button type='button'    class='btn btn-outline-success' href='#' data-toggle='popover'>" + data[i].title + " <span></span></button></h2></td><td> <h2> <button type='button' class='btn btn-outline-success' href='#' data-toggle='popover'>" + data[i].title + " <span></span></button></h2></td><td> <h2> <button type='button' class='btn btn-outline-success' href='#' data-toggle='popover'>" + data[i].title + " <span></span></button></h2></td><td> <h2> <button type='button' class='btn btn-outline-success' href='#' data-toggle='popover'>" + data[i].title + " <span></span></button></h2></td><td> <h2> <button type='button' class='btn btn-outline-success' href='#' data-toggle='popover'>" + data[i].title + " <span></span></button></h2></td><td> <h2> <button type='button' class='btn btn-outline-success' href='#' data-toggle='popover'>" + data[i].title + " <span></span></button></h2></td><td> <h2> <button type='button' class='btn btn-outline-success' href='#' data-toggle='popover'>" + data[i].title + " <span></span></button></h2></td><td> <h2> <button type='button' class='btn btn-outline-success' href='#' data-toggle='popover'>" + data[i].title + " <span></span></button></h2></td></tr>");
    ...
    $("[data-toggle=popover]").popover({
        ...
        if ($(this).hasClass('btn btn-outline-success btn-success')) {
            //alert('bingo');
            $("#btnSubmit").hide();
            $("#btnCancel").show();
        };
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success == true) {
                        ...
                        $('#slotdata tr:nth(' + rowIndex + ')').find('td').eq(tdIndex).find("button").removeClass();
                        $('#slotdata tr:nth(' + rowIndex + ')').find('td').eq(tdIndex).find("button").addClass("btn btn-outline-success btn-success")
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success == true) {
                        ...
                        //rowIndex, tdIndex; btn btn-danger
                        $('#slotdata tr:nth(' + rowIndex + ')').find('td').eq(tdIndex).find("button").removeClass();
                        $('#slotdata tr:nth(' + rowIndex + ')').find('td').eq(tdIndex).find("button").addClass("btn btn-outline-success")
                        $("[data-toggle=popover]").popover('hide');
                    }
                },
                error: function () {
